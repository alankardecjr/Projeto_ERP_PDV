...
class JanelaCadastroDespesas(tk.Toplevel):
    def __init__(self, master, dados_despesa=None):
       ...
       # --- Paleta de cores ---
        ...
        self.list_formas = ["Dinheiro", "Cartão", "PIX", "Boleto", "Outros"]
    ...
    def criar_widgets(self):
        ...
        # Linha de Configurações (Ajuste de tamanhos solicitado)
        # Categoria (Maior), Forma e Recorrencia (Menores)
        ...
        tk.Label(self.frame_parcelas, text="PARCELAS:", bg="#E2E8F0", font=("Segoe UI", 8, "bold")).pack(side="left")
        ...
        self.lbl_calculo = tk.Label(self.frame_parcelas, text="= 1x R$ 0.00", bg="#E2E8F0", font=("Segoe UI", 8, "italic"), fg=self.cor_destaque)
        ...
        # Bind Hovers
        self.btn_salvar.bind("<Enter>", lambda e: e.widget.config(bg=self.cor_hover_field))
