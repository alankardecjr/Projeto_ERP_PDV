...
class JanelaGerenciarReceitas(tk.Toplevel):
    ...
    def criar_widgets(self):
        ...
        self.btn_salvar = tk.Button(main_frame, text="CONSOLIDAR / SALVAR RECEITA", bg=self.cor_btn_acao, fg="white", font=("Segoe UI", 10, "bold"), relief="flat", cursor="hand2", command=self.salvar_crud)
